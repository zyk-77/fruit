...
{
    //播放音频
    music->setSource(QUrl::fromLocalFile(":/image/music/Ninety - Summer Seaside (Inst.) [mqms2].wav"));
...
void Fruit::paintEvent(QPaintEvent *event){
    ...
    if(display!="gameover!") painter.drawText(480,50,display);
    else painter.drawText(295,325,display);
